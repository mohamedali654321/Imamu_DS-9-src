...
@Component({
  ...
  standalone: true,
  imports: [NgIf, ThemedResultsBackButtonComponent, ThemedItemPageTitleFieldComponent, ThemedMetadataRepresentationListComponent, DsoEditMenuComponent, MetadataFieldWrapperComponent, ThemedThumbnailComponent, GenericItemPageFieldComponent, RelatedItemsComponent, RouterLink, TabbedRelatedEntitiesSearchComponent, AsyncPipe, TranslateModule, ItemPageImgFieldComponent, ThemedMediaViewerComponent, KwareNavigateItemsComponent, SimpleViewStatisticsComponent, KwareSocialSharingComponent, CollectionsComponent],
